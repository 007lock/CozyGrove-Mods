...
namespace Ashnel.CozyGrove.InstantCooking
{
    public class MyMod : MelonMod
    {
        private const string PreferenceCategoryId = "Ashnel.CozyGrove.InstantCooking";
        ...
        {
            if (SceneManager.GetActiveScene().name == "Game" && GameUI.Instance != null)
            {
                Cheats.instantDelivery = true;
            }
